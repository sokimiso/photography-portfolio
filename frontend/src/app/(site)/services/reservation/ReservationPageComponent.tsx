  ...
  return (
    ...
    >
      <motion.div
        ...
        className="grid sm:grid-cols-1 md:grid-cols-2 gap-6 bg-white/5 dark:bg-gray-900/50 backdrop-blur-md p-10 rounded-2xl shadow-lg relative overflow-hidden items-stretch"
      >
        {/* Reservation Form */}
        <form
