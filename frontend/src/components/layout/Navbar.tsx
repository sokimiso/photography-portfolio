...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="shadow-md top-0 z-50 relative"
    >
      <div className="flex navbar h-16 items-stretch justify-between">
        ...
        <div className="flex items-stretch space-x-4">
          ...
          <div className="hidden md:flex items-stretch uppercase text-sm space-x-3">
        ...
        <div className="md:hidden flex items-center">
          <button
            ...
            className=" focus:outline-none bg-[var(--primary)] p-1 rounded"
